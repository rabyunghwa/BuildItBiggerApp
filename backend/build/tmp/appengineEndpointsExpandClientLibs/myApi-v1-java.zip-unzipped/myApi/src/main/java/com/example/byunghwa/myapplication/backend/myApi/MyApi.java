 ...
 * on 2016-04-02 at 12:29:53 UTC 
 * Modify at your own risk.
 */

package com.example.byunghwa.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://YOUR OWN GOOGLE APP ENGINE APP NAME.appspot.com/_ah/api/";
  ...
  public class SayHi extends MyApiRequest<com.example.byunghwa.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.byunghwa.myapplication.backend.myApi.model.MyBean.class);
